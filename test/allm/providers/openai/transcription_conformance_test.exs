defmodule ALLM.Providers.OpenAI.TranscriptionConformanceTest do
  @moduledoc """
  ...
  `OPENAI_API_KEY` (otherwise case 4 would upload 25 MB).

  Case 4 allocates `max_audio_bytes() + 1` bytes (about 25 MB) once per run;
