...
- **Serializability (Layer-A round-trip of the Layer-B engine):** ETF + JSON round-trip equality with stamped `:id`; backward-compat decode of an id-less map. Blocking per AGENT_DESIGN_SPEC §6.
