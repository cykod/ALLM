...
| 23.4 | Spec §40, `guides/tools.md` section, `examples/21_compact_tools.exs` live gate, CHANGELOG | docs | Completed |
| 23.5 | `[CHORE]` sweep for deferrals raised in 23.1–23.4 | — | Completed |
