...
> **SUPERSEDED (2026-09-24).** Never built. Audio shipped as Phase 25 from `steering/2026-09-24_SST_SUPPORT.md` (two behaviours and two engine slots, not the single `ALLM.AudioAdapter` described below), specified in spec §37. Do not implement from this document.
